/*  David Turati
    ...
    Implementação do metodo de solução de equaçoes lineares de Gauss
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
void solucao(float **mt, int m, int n){
  ...
  } //encontra a primeira solução da matriz, ou seja o ultimo coeficiênte
  ...
  for (i=n-1;i>=0;i--){
    ...
    for(j=i+1;j<=n-1;j++){
      ...
      }  //divide a soma pelo elemento so vetor dos coeficiêntes em sua respectiva posição
